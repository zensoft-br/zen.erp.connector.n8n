...
import * as ops from './printing.service.operations';
import { operations, fields } from './printing.service.fields';

export class PrintingService implements INodeType {
  description: INodeTypeDescription = {
    displayName: 'PrintingService',
